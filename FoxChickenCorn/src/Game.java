...
public class Game {
	...
	public static void printIntro ()
	{
		...
		System.out.println("One day a farmer wanted to cross from the left to the right bank of a river taking a fox, a chicken and a bag of corn with him. The problem is that he just has a small boat and can only take one item with him on each crossing. The problem is that: ");
		System.out.println();
	...
	// TODO: All input checking should be refactored into one method probably.
	...
	public static boolean checkLogic ()
	{
		...
		else if ((fox.side.equals("right")) && (farmer.side.equals("right")) && (corn.side.equals("right")) && (chicken.side.equals("right")))
		{
